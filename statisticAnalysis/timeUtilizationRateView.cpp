...
void TimeUtilizationRateView::paintEvent(QPaintEvent *event)
{
    ...
    painter.drawText(QRect(rect2.x() + 10, rect2.y(), rect2.width() - 50, rect2.height()), Qt::AlignVCenter | Qt::AlignLeft, tr("时间稼动率"));
    painter.restore();
